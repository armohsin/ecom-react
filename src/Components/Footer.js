...
const Footer = () => {
  ...
  <div className="relative block h-32 lg:col-span-2 lg:h-full">
    <img
      src="https://images.unsplash.com/photo-1549570652-97324981a6fd?q=80&w=1885&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
      alt=""
      className="absolute inset-0 h-full w-full object-cover"
    />
  </div>

  <div className="px-4 bg-blue-700 py-16 sm:px-6 lg:col-span-3 lg:px-8">
    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
      <div>
        <p>
          <span className="text-xs text-white uppercase tracking-wide text-white"> Call us </span>

          <a href="#" className="block text-white text-2xl font-medium text-white hover:opacity-75 sm:text-3xl">
            0123456789
          </a>
        </p>

        <ul className="mt-8 space-y-1 text-white text-sm text-white">
